...
export const translations: Translations = {
    '한국어': {
      ...
      summaryText: '요약본 텍스트',
      // YoutubeWebView
      youtubeViewTitle: 'Youtube, 웹사이트 링크',
      youtubeViewDescription: 'Youtube 영상 / 채널 링크, 웹사이트 링크를 입력하세요.',
      youtubeViewPlaceholder: 'https://youtube.com/watch?v=...',
      youtubeSummarizing: '스크랩 및 요약 진행 중...',
      youtubeFeatureDescription: 'Youtube 영상 또는 웹사이트 링크를 붙여넣으면 AI가 콘텐츠를 분석하고 핵심 내용을 요약해 드립니다.',
      // App.tsx
    ...
    'English': {
      ...
      youtubeViewTitle: 'Youtube, Website Link',
      youtubeViewDescription: 'Enter a Youtube video / channel link, or a website link.',
      youtubeViewPlaceholder: 'https://youtube.com/watch?v=...',
      youtubeSummarizing: 'Scraping and summarizing...',
      youtubeFeatureDescription: 'Paste a link to a Youtube video or website, and the AI will analyze the content and provide a summary of the key points.',
    ...
    'Español': {
      ...
      convert: 'Resumen de Youtube y Web',
      recent: 'Recientes',
    ...
    'Français': {
      ...
      fullText: 'Texte Original',
      summaryText: 'Texte Résumé',
    },
    '日本語': {
      newChat: '新規チャット',
      home: 'ホーム',
    ...
    'Deutsch': {
        ...
        convert: 'Youtube & Web Zusammenfassung',
        recent: 'Letzte',
        signIn: 'Anmelden',
        signOut: 'Abmelden',
        search: 'Suchen',
        ...
        summaryText: 'Zusammenfassungstext',
    }
};
